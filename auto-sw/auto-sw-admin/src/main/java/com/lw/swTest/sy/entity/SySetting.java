...
@Getter
@Setter
@TableName("sy_setting")
@ApiModel(value = "SySetting对象", description = "系统设置表")
public class SySetting implements Serializable {
    ...
    private String settingTheme;

    @ApiModelProperty("系统语言")
    private String settingLingo;

    @ApiModelProperty("自动登录")
    private String settingAutoLogin;
