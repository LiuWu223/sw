...
@Setter
@TableName("sy_route")
@ApiModel(value = "SyRoute对象", description = "路由表")
public class SyRoute implements Serializable {
    ...
    private Long routeHigher;

    @ApiModelProperty("路由component")
